...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='mat', choices=["mat", "mat_dec"])
    ...
    # add for offline mat
    parser.add_argument("--offline_epoch", type=int, default=100, help="how many epoch for training")
    parser.add_argument("--batch_size", type=int, default=3200, help="how many steps used for each training iteration")
    parser.add_argument("--offline_data", type=str, default="37001_38000.list",
                        help="by default None. set the path to offline dataset.")
